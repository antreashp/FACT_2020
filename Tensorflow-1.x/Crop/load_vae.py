...
import sys
sys.path.insert(0, "/Users/abhijith/msc-ai/fact/ELDR/scvis/lib/scvis/")
...
def load_vae(input_dim, model_file, feature_transform = None):
    ...
    # Model Configuration
    try:
        config_file_yaml = open("/Users/abhijith/msc-ai/fact/ELDR/scvis/lib/scvis/config/model_config.yaml", "r")
